...
import {
  ...
  Routes, Route, Link, useNavigate, useMatch, useParams
...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/')
    props.notificationHandler(`Added ${content.value}`)
    setTimeout(() => {
  ...
  return (
    ...
    <div>
      ...
      <Routes>
        ...
        <Route path="/create" element={<CreateNew addNew={addNew} notificationHandler={notificationHandler}/>} /> 
